...
p <- ggplot(
  population,
  aes(
    x = factor(연령별, levels = c("0 - 4세", "5 - 9세", "10 - 14세", "15 - 19세", "20 - 24세", "25 - 29세", "30 - 34세", "35 - 39세", "40 - 44세", "45 - 49세", "50 - 54세", "55 - 59세", "60 - 64세", "65 - 69세", "70 - 74세", "75 - 79세", "80 - 84세", "85세이상", "연령미상")),
    y = 인구수 / 10000,
    fill = 분류
  )
) +
  ...
  coord_flip() +
  labs(
    title = "서울 인구 구조 변화 ({as.integer(frame_time)}년)",
    x = ""
  ) +
  # scale_y_continuous(labels = paste0(as.character(c(seq(2, 0, -1), seq(1, 2, 1))), "m")) +
  scale_fill_manual(
    values = c("남자" = "skyblue", "여자" = "hotpink"),
