...
#'    \item{업종1}{해당 해외진출기업 업종
#'    제조업, 금융·보험업, 도매 및 소매업, 운수업, 농업·임업 및 어업, 건설·공사업, 서비스업, 광업·자원개발, 부동산 및 임대업, 기타, 제조업}
#'    \item{업종2}{해당 해외진출기업 업종
#'    목재·가구·펄프·종이, 식료품, 출판·영상·방송통신 및 정보, 사업 시설관리 및 사업지원, 예술·스포츠 및 여가 관련, 기타 서비스업 등}
#'    \item{취급분야}{해당 해외진출기업 취급분야
#'    생산법인, 지점, 판매법인, 서비스법인,연락사무소}
#'    \item{본사파견}{해당 해외진출기업 본사파견수}
#'    \item{현지채용}{해당 해외진출기업 현지채용수}
#'    \item{내수.수출}{해당 해외진출기업 내수 및 수출 상태
#'    수출 및 내수 병행, 100% 주재국 내수시장 공급, 100% 제3국 수출}
